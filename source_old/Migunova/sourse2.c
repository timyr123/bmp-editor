...
main()
{
    ...
    //чтение двух файлов(тип, размер, резервированные байты, длина, высота, «мусор»)
    /*
    fread(&type, 2, 1, fin1);
    fread(&size, 4, 1, fin1);
    fread(&res, 4, 1, fin1);
...
/*
    ...
    printf(" razmery: %d %d\n", size , size2);// вывод размеров изображений
    

//прогоняем через цикл оба изображения и сравниваем их попиксельно, если совпадают пиксели увеличивае6м счетчик на единицу.
/*
   for(i=0; i<h ; i++)
    {
	for(j=0; j<w ; j++)
